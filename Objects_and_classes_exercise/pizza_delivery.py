class PizzaDelivery:
    ...
    def make_order(self):
        self.ordered = True
        return_str = ', '.join([f'{key}: {value}' for key, value in self.ingredients.items()])
        return f"You've ordered pizza {self.name} prepared with {return_str} and the price will be {self.price}lv."
